...
cdbl FullyInclusive::coeffs::cgBar1_h1(cdbl m2, cdbl q2, cdbl s) {
...
cdbl FullyInclusive::coeffs::cgBar1_h2(cdbl m2, cdbl q2, cdbl s) {
partonic_chi(m2,s) partonic_chiq(m2,q2)
return -Power(pi,2)/6. + 2*Li2(-chi) + 2*Li2(chi) - ln(chi)/2. - ln(chi)*(ln(chiq) - ln(chi + chiq) - ln(1 + chi*chiq));
}

cdbl FullyInclusive::coeffs::cgBar1_h3(cdbl m2, cdbl q2, cdbl s) {
partonic_chi(m2,s) partonic_chiq(m2,q2)
return ln(1 - chi) + ln(1 + chi) + (-ln(chi) + ln(chiq) - ln(chi + chiq) - ln(1 + chi*chiq))/2.;
}


cdbl FullyInclusive::coeffs::cgBar1_F2_VV(cdbl m2, cdbl q2, cdbl s) {
partonic_chi(m2,s) partonic_chiq(m2,q2)
cdbl h1 = FullyInclusive::coeffs::cgBar1_h1(m2,q2,s);
cdbl h2 = FullyInclusive::coeffs::cgBar1_h2(m2,q2,s);
cdbl h3 = FullyInclusive::coeffs::cgBar1_h3(m2,q2,s);
...
cdbl FullyInclusive::coeffs::cgBar1_FL_VV(cdbl m2, cdbl q2, cdbl s) {
partonic_chi(m2,s) partonic_chiq(m2,q2)
...
cdbl FullyInclusive::coeffs::cgBar1_x2g1_VV(cdbl m2, cdbl q2, cdbl s) {
partonic_chi(m2,s) partonic_chiq(m2,q2)
cdbl h1 = FullyInclusive::coeffs::cgBar1_h1(m2,q2,s);
cdbl h2 = FullyInclusive::coeffs::cgBar1_h2(m2,q2,s);
cdbl h3 = FullyInclusive::coeffs::cgBar1_h3(m2,q2,s);
...
cdbl FullyInclusive::coeffs::cgBar1_F2_AA(cdbl m2, cdbl q2, cdbl s) {
partonic_chi(m2,s) partonic_chiq(m2,q2)
cdbl h1 = FullyInclusive::coeffs::cgBar1_h1(m2,q2,s);
cdbl h2 = FullyInclusive::coeffs::cgBar1_h2(m2,q2,s);
cdbl h3 = FullyInclusive::coeffs::cgBar1_h3(m2,q2,s);
...
cdbl FullyInclusive::coeffs::cgBar1_FL_AA(cdbl m2, cdbl q2, cdbl s) {
partonic_chi(m2,s) partonic_chiq(m2,q2)
cdbl h1 = FullyInclusive::coeffs::cgBar1_h1(m2,q2,s);
cdbl h2 = FullyInclusive::coeffs::cgBar1_h2(m2,q2,s);
cdbl h3 = FullyInclusive::coeffs::cgBar1_h3(m2,q2,s);
...
cdbl FullyInclusive::coeffs::cgBar1_xF3_VA(cdbl m2, cdbl q2, cdbl s) {
return 0.;
}

cdbl FullyInclusive::coeffs::cgBar1_g4_VA(cdbl m2, cdbl q2, cdbl s) {
return 0.;
}

cdbl FullyInclusive::coeffs::cgBar1_gL_VA(cdbl m2, cdbl q2, cdbl s) {
return 0.;
}

cdbl FullyInclusive::coeffs::cgBar1_x2g1_AA(cdbl m2, cdbl q2, cdbl s) {
return FullyInclusive::coeffs::cgBar1_x2g1_VV(m2,q2,s);
}
